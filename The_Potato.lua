...
minetest.register_craftitem("rangedweapons:hand_grenade_nopin", {
	...
	range = 0,
	inventory_image = "rangedweapons_potato.png",
...
minetest.register_globalstep(function(dtime, player, pos)
	...
	local pos = player:get_pos()
		if player:get_wielded_item():get_name() == "rangedweapons:grenade_nopin.png" then
...
local rangedweapons_grenade = {
	...
	textures = {"rangedweapons_potato.png"},
	lastpos= {},
