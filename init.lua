...
if inv:contains_item("main", "rangedweapons:ammo "..PowerCaps.power_consumption) and 
playerMeta:get_float("rw_cooldown") <= 0 then
...
inv:remove_item("main", "rangedweapons:ammo "..PowerCaps.power_consumption)
...
dofile(modpath.."/helicopter2.lua")
dofile(modpath.."/artic.lua")
dofile(modpath.."/enemy.lua")
dofile(modpath.."/flamer.lua")
dofile(modpath.."/gunner.lua")
dofile(modpath.."/tank.lua")
dofile(modpath.."/helicopter.lua")
dofile(modpath.."/spawn.lua")
dofile(modpath.."/dog.lua")
...
local mobs_shoot_arrow = function(itemstack, player)
	for _,arrow in ipairs(arrows) do
		if player:get_inventory():get_stack("main", player:get_wield_index()+1):get_name() == arrow[1] then
			...
			local obj = minetest.env:add_entity({x=playerpos.x,y=playerpos.y+0.5,z=playerpos.z}, arrow[2])
			local dir = player:get_look_dir()
...
mobs:register_arrow("rangedweapons:rangedweapons_bullet", {
	visual = "sprite",
	visual_size = {x=0.5, y=0.5},
	textures = {"rangedweapons_bullet2.png"},
	velocity = 15,
    --acceleration = 5,
    glow = 20,
    drop = true,
...
mobs:register_arrow("rangedweapons:rangedweapons_flame", {
	visual = "cube",
	visual_size = {x=0.1, y=0.1},
    texture = {"empty.png"},
	velocity = 20,
    tail = 1,
	tail_texture = "rangedweapons_fire.png",
	tail_size = 6,
	glow = 100,
	expire = 1,
    drop = true,
